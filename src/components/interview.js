            ...
            <div className={`${styles.grid}`}>
                <div className={`${styles.content}`}>
                    ...
                    <div className={`buttons`}>
                        <a href="https://drive.google.com/file/d/0B7c5i0P23QdnTGN5bDBmVHFDMTA/view" target="_blank" rel="noreferrer noopener" className={`btn`}>Clint Charles Fryer Interview</a><br />
                        <a href="https://www.youtube.com/watch?v=FHjLHNzZP8w" target="_blank" rel="noreferrer noopener" className={`btn`}>Radio Interview</a>
                    </div>
                </div>
